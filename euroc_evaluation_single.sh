...
./Examples/Monocular-Inertial/mono_inertial_euroc ./Vocabulary/ORBvoc.txt ./Examples/Monocular-Inertial/EuRoC.yaml "$pathDatasetEuroc"/"$1" ./Examples/Monocular-Inertial/EuRoC_TimeStamps/"$1".txt dataset-"$1"_monoi
echo "------------------------------------"
echo "Evaluation of "$1" trajectory with Monocular-Inertial sensor"
python evaluation/evaluate_ate_scale.py "$pathDatasetEuroc"/"$1"/mav0/state_groundtruth_estimate0/data.csv f_dataset-"$1"_monoi.txt --plot "$1"_monoi.pdf --verbose --verbose2
